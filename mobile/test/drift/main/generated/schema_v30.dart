...
class LocalAssetEntity extends Table
  ...
  late final GeneratedColumn<String> priorRemoteId = GeneratedColumn<String>(
    'prior_remote_id',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> syncedChecksum = GeneratedColumn<String>(
    'synced_checksum',
    aliasedName,
    true,
    type: DriftSqlType.string,
...
class LocalAssetEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || priorRemoteId != null) {
      map['prior_remote_id'] = Variable<String>(priorRemoteId);
    }
...
class LocalAssetEntityCompanion extends UpdateCompanion<LocalAssetEntityData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (priorRemoteId.present) {
      map['prior_remote_id'] = Variable<String>(priorRemoteId.value);
    }
...
class DatabaseAtV30 extends GeneratedDatabase {
  ...
  late final Index idxLocalAssetPriorRemoteId = Index(
  ...
  late final Index idxAssetOcrAssetId = Index(
